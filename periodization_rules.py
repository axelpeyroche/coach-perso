...
EXERCICES_DEFAUT = [
    ...
    # --- Exercices issus des modules EPC ---
    {
        "nom": "Sit up", "slug": "sit-up",
        "categorie_musculaire": "gainage", "niveau_progression": "debutant",
        "tempo": "X/0/2/0", "pause_isometrique_sec": None,
        "muscles_principaux": "Grand droit, Fléchisseurs de hanche",
        "est_mouvement_evaluation": False,
    },
    {
        "nom": "Hollow body actif", "slug": "hollow-actif",
        "categorie_musculaire": "gainage", "niveau_progression": "intermediaire",
        "tempo": "X/0/X/0", "pause_isometrique_sec": None,
        "muscles_principaux": "Gainage antérieur, Grand droit",
        "description": "Position banane creuse, lombaires au sol, jambes tendues à 30 cm du sol",
        "est_mouvement_evaluation": False,
    },
    {
        "nom": "Superman (extension dorsale)", "slug": "superman",
        "categorie_musculaire": "gainage", "niveau_progression": "debutant",
        "tempo": "X/0/X/0", "pause_isometrique_sec": None,
        "muscles_principaux": "Érecteurs du rachis, Fessiers, Rhomboïdes",
        "est_mouvement_evaluation": False,
    },
    {
        "nom": "Extension triceps / position proactive dips", "slug": "triceps-extension-dips",
        "categorie_musculaire": "push", "niveau_progression": "intermediaire",
        "tempo": "2/1/X/0", "pause_isometrique_sec": None,
        "muscles_principaux": "Triceps brachial",
        "description": "Extension triceps aux parallettes depuis position haute du dip",
        "est_mouvement_evaluation": False,
    },
    {
        "nom": "Pompe prise large", "slug": "pompe-large",
        "categorie_musculaire": "push", "niveau_progression": "debutant",
        "tempo": "2/1/X/0", "pause_isometrique_sec": None,
        "muscles_principaux": "Pectoraux larges, Deltoïdes antérieurs",
        "est_mouvement_evaluation": False,
    },
    {
        "nom": "Planche dynamique (tapotements)", "slug": "planche-dynamique",
        "categorie_musculaire": "gainage", "niveau_progression": "intermediaire",
        "tempo": "X/0/X/0", "pause_isometrique_sec": None,
        "muscles_principaux": "Gainage, Deltoïdes",
        "description": "En position planche, tapoter alternativement chaque épaule avec la main opposée",
        "est_mouvement_evaluation": False,
    },
    {
        "nom": "Curl biceps en traction", "slug": "curl-biceps-traction",
        "categorie_musculaire": "pull", "niveau_progression": "intermediaire",
        "tempo": "X/1/2/0", "pause_isometrique_sec": None,
        "muscles_principaux": "Biceps brachial",
        "description": "En suspension à la barre, flexion du coude sans tirer avec le dos",
        "est_mouvement_evaluation": False,
    },
    {
        "nom": "Extension de hanche (pont fessier)", "slug": "extension-hanche",
        "categorie_musculaire": "jambes", "niveau_progression": "debutant",
        "tempo": "2/1/X/0", "pause_isometrique_sec": None,
        "muscles_principaux": "Fessiers, Ischio-jambiers",
        "est_mouvement_evaluation": False,
    },
    {
        "nom": "Chaise isométrique (wall sit)", "slug": "chaise-isometrique",
        "categorie_musculaire": "jambes", "niveau_progression": "debutant",
        "tempo": "X/0/X/0", "pause_isometrique_sec": None,
        "muscles_principaux": "Quadriceps, Fessiers",
        "description": "Dos au mur, cuisses parallèles au sol, tenir la position",
        "est_mouvement_evaluation": False,
    },
    {
        "nom": "Traction partielle (amplitude réduite)", "slug": "traction-partielle",
        "categorie_musculaire": "pull", "niveau_progression": "avance",
        "tempo": "X/1/2/0", "pause_isometrique_sec": None,
        "muscles_principaux": "Grand dorsal, Biceps",
        "description": "Traction stricte limitée aux 30 derniers degrés (partie haute du mouvement)",
        "est_mouvement_evaluation": False,
    },
    {
        "nom": "Dip partiel (amplitude réduite)", "slug": "dip-partiel",
        "categorie_musculaire": "push", "niveau_progression": "avance",
        "tempo": "2/1/X/0", "pause_isometrique_sec": None,
        "muscles_principaux": "Triceps, Pectoraux",
        "description": "Dip limité aux 30 derniers degrés (phase de verrouillage)",
        "est_mouvement_evaluation": False,
    },
    {
        "nom": "Le Y (rhomboïdes / épaules postérieures)", "slug": "le-y",
        "categorie_musculaire": "pull", "niveau_progression": "debutant",
        "tempo": "2/1/X/0", "pause_isometrique_sec": None,
        "muscles_principaux": "Rhomboïdes, Trapèzes moyens, Deltoïdes postérieurs",
        "description": "Allongé ventre au sol, bras en Y, soulever vers le haut",
        "est_mouvement_evaluation": False,
    },
    {
        "nom": "Rotateur long (bras tendu)", "slug": "rotateur-long",
        "categorie_musculaire": "pull", "niveau_progression": "debutant",
        "tempo": "2/1/X/0", "pause_isometrique_sec": None,
        "muscles_principaux": "Grand dorsal, Rotateurs externes",
        "description": "En suspension, rotation externe du bras tendu le long du corps",
        "est_mouvement_evaluation": False,
    },
]
